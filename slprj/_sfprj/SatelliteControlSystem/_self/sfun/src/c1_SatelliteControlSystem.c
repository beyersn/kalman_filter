...
static void initialize_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void initialize_params_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void enable_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void disable_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void set_sim_state_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void sf_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void c1_chartstep_c1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void initSimStructsc1_SatelliteControlSystem
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_b_Ts, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_b_q, const char_T *c1_identifier, real_T
  c1_y[4]);
static void c1_d_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[4]);
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_Attitude_I_C, const char_T *c1_identifier,
  real_T c1_y[4]);
static void c1_f_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[4]);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_g_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_h_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[16]);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_eml_scalar_eg(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_i_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_j_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_SatelliteControlSystem, const
  char_T *c1_identifier);
static uint8_T c1_k_emlrt_marshallIn(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_SatelliteControlSystemInstanceStruct
  *chartInstance);
  ...
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_SatelliteControlSystem = 0U;
}
  ...
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_SatelliteControlSystem;
   ...
   *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_SatelliteControlSystem = c1_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
     "is_active_c1_SatelliteControlSystem");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_SatelliteControlSystem(chartInstance);
  ...
  (SFc1_SatelliteControlSystemInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_SatelliteControlSystem(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_SatelliteControlSystemInstanceStruct *chartInstance;
  chartInstance = (SFc1_SatelliteControlSystemInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_SatelliteControlSystem_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_SatelliteControlSystem), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_SatelliteControlSystem);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_SatelliteControlSystem_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(37673816U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(204510039U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2454722207U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2890864792U);
}

mxArray *sf_c1_SatelliteControlSystem_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("I6uDQ06hyuFxUoQ76gTo4G");
...
static const mxArray *sf_get_sim_state_info_c1_SatelliteControlSystem(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Attitude_I_C\",},{M[4],M[0],T\"Ts\",S'l','i','p'{{M1x2[95 97],M[0],}}},{M[4],M[0],T\"q\",S'l','i','p'{{M1x2[93 94],M[0],}}},{M[8],M[0],T\"is_active_c1_SatelliteControlSystem\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_SatelliteControlSystem_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_SatelliteControlSystemInstanceStruct *chartInstance;
    chartInstance = (SFc1_SatelliteControlSystemInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,98,111,226,610);
...
{
  return "XwGx0iGWrZhH9M235mVOuE";
}

static void sf_opaque_initialize_c1_SatelliteControlSystem(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_SatelliteControlSystemInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_SatelliteControlSystem
    ((SFc1_SatelliteControlSystemInstanceStruct*) chartInstanceVar);
  initialize_c1_SatelliteControlSystem
    ((SFc1_SatelliteControlSystemInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_SatelliteControlSystem(void *chartInstanceVar)
{
  enable_c1_SatelliteControlSystem((SFc1_SatelliteControlSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_SatelliteControlSystem(void *chartInstanceVar)
{
  disable_c1_SatelliteControlSystem((SFc1_SatelliteControlSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_SatelliteControlSystem(void *chartInstanceVar)
{
  sf_c1_SatelliteControlSystem((SFc1_SatelliteControlSystemInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_SatelliteControlSystem
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_SatelliteControlSystem
    ((SFc1_SatelliteControlSystemInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_SatelliteControlSystem();/* state var info */
...
extern void sf_internal_set_sim_state_c1_SatelliteControlSystem(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_SatelliteControlSystem
    ((SFc1_SatelliteControlSystemInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_SatelliteControlSystem
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_SatelliteControlSystem(S);
}

static void sf_opaque_set_sim_state_c1_SatelliteControlSystem(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_SatelliteControlSystem(S, st);
}

static void sf_opaque_terminate_c1_SatelliteControlSystem(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_SatelliteControlSystemInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_SatelliteControlSystem
      ((SFc1_SatelliteControlSystemInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_SatelliteControlSystem
    ((SFc1_SatelliteControlSystemInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_SatelliteControlSystem(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_SatelliteControlSystem
      ((SFc1_SatelliteControlSystemInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_SatelliteControlSystem(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2564966275U));
  ssSetChecksum1(S,(1475094609U));
  ssSetChecksum2(S,(1103023463U));
  ssSetChecksum3(S,(1086238015U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_SatelliteControlSystem(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_SatelliteControlSystem(SimStruct *S)
{
  SFc1_SatelliteControlSystemInstanceStruct *chartInstance;
  chartInstance = (SFc1_SatelliteControlSystemInstanceStruct *)malloc(sizeof
    (SFc1_SatelliteControlSystemInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_SatelliteControlSystemInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_SatelliteControlSystem;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_SatelliteControlSystem;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_SatelliteControlSystem;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_SatelliteControlSystem;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_SatelliteControlSystem;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_SatelliteControlSystem;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_SatelliteControlSystem;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_SatelliteControlSystem;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_SatelliteControlSystem;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_SatelliteControlSystem;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_SatelliteControlSystem;
...
void c1_SatelliteControlSystem_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_SatelliteControlSystem(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_SatelliteControlSystem(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_SatelliteControlSystem(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_SatelliteControlSystem_method_dispatcher.\n"
