#ifndef __c2_SatelliteControlSystem_h__
#define __c2_SatelliteControlSystem_h__
...
#ifndef typedef_SFc2_SatelliteControlSystemInstanceStruct
#define typedef_SFc2_SatelliteControlSystemInstanceStruct
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_SatelliteControlSystem;
  ...
  real_T c2_DCM_s2c[9];
  boolean_T c2_DCM_s2c_not_empty;
  real_T c2_Ts;
  boolean_T c2_Ts_not_empty;
  real_T c2_R_k[36];
...
#endif                                 /*typedef_SFc2_SatelliteControlSystemInstanceStruct*/
...
extern void c2_SatelliteControlSystem_method_dispatcher(SimStruct *S, int_T
  method, void *data);
