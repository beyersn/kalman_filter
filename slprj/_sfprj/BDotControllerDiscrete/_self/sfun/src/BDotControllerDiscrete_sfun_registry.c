...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_BDotControllerDiscrete_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Control_System_Library_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_BDotControllerDiscrete_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_Control_System_Library_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_BDotControllerDiscrete_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Control_System_Library_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "BDotControllerDiscrete") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BDotControllerDiscrete_autoinheritance_info(nlhs,plhs,3,newRhs);
  }

  if (strcmp(machineName, "Control_System_Library") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Control_System_Library_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_BDotControllerDiscrete_get_eml_resolved_functions_info(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Control_System_Library_get_eml_resolved_functions_info(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "BDotControllerDiscrete") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_BDotControllerDiscrete_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
  ...
  if (strcmp(machineName, "Control_System_Library") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Control_System_Library_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_BDotControllerDiscrete_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_Control_System_Library_method_dispatcher(SimStruct *S,
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"BDotControllerDiscrete")) {
    return(sf_BDotControllerDiscrete_method_dispatcher(simstructPtr,
            chartFileNumber,specsCksum,method,data));
  }

  if (!strcmp(machineName,"Control_System_Library")) {
    return(sf_Control_System_Library_method_dispatcher(simstructPtr,
            chartFileNumber,specsCksum,method,data));
  }
...
extern void BDotControllerDiscrete_terminator(void);
extern void Control_System_Library_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    BDotControllerDiscrete_terminator();
    Control_System_Library_terminator();
    sf_debug_terminate();
  }
...
extern void BDotControllerDiscrete_initializer(void);
extern void Control_System_Library_initializer(void);
extern void BDotControllerDiscrete_register_exported_symbols(SimStruct* S);
extern void Control_System_Library_register_exported_symbols(SimStruct* S);
extern void BDotControllerDiscrete_debug_initialize(void);
extern void Control_System_Library_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  BDotControllerDiscrete_register_exported_symbols(S);
  Control_System_Library_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      BDotControllerDiscrete_debug_initialize();
    }

    BDotControllerDiscrete_initializer();
    if (!simModeIsRTWGen) {
      Control_System_Library_debug_initialize();
    }

    Control_System_Library_initializer();
  }
