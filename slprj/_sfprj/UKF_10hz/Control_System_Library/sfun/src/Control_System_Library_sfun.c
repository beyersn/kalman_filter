  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Control_System_Library")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(432848051U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(392933715U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1976594518U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3561817333U);
        } else if (nrhs==4) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 7:
      {
        if (strcmp(aiChksum, "4NWJNu4Lwi14IqXavr9FsE") == 0) {
...
void Control_System_Library_debug_initialize(void)
{
  _Control_System_LibraryMachineNumber_ = sf_debug_initialize_machine(
    "Control_System_Library","sfun",1,1,0,0,0);
...
mxArray* load_Control_System_Library_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "Control_System_Library", "UKF_10hz");
