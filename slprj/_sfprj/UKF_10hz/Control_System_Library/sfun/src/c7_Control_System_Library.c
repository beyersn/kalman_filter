...
static const char * c7_debug_family_names[23] = { "Torque_c_temp", "Torque_c",
  "w_c_temp", "x_km1", "Ts_rk4", "k1", "k2", "k3", "k4", "x_k", "w_s_temp",
  "nargin", "nargout", "I_c", "w_init_s", "Torque_s", "q0_i_s", "q_s_c", "Ts",
  "w_s", "q_i_s", "w_c_km1", "q_i_c_km1" };
...
static void sf_c7_Control_System_Library
  (SFc7_Control_System_LibraryInstanceStruct *chartInstance);
static void c7_chartstep_c7_Control_System_Library
  (SFc7_Control_System_LibraryInstanceStruct *chartInstance);
  ...
  (SFc7_Control_System_LibraryInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_Control_System_Library(chartInstance);
  ...
  (SFc7_Control_System_LibraryInstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(c7_x_km1, 3U, c7_f_sf_marshallOut,
    c7_f_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c7_Ts_rk4, 4U, c7_e_sf_marshallOut,
    c7_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c7_k1, 5U, c7_f_sf_marshallOut,
    c7_f_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c7_k2, 6U, c7_f_sf_marshallOut,
    c7_f_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c7_k3, 7U, c7_f_sf_marshallOut,
    c7_f_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c7_k4, 8U, c7_f_sf_marshallOut,
    c7_f_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c7_x_k, 9U, c7_f_sf_marshallOut,
    c7_f_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c7_w_s_temp, 10U, c7_c_sf_marshallOut,
    c7_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c7_nargin, 11U, c7_e_sf_marshallOut,
    c7_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c7_nargout, 12U, c7_e_sf_marshallOut,
    c7_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c7_I_c, 13U, c7_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c7_w_init_s, 14U, c7_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c7_Torque_s, 15U, c7_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c7_q0_i_s, 16U, c7_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c7_q_s_c, 17U, c7_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c7_Ts, 18U, c7_e_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c7_w_s, 19U, c7_d_sf_marshallOut,
    c7_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c7_q_i_s, 20U, c7_c_sf_marshallOut,
    c7_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(chartInstance->c7_w_c_km1, 21U,
    c7_b_sf_marshallOut, c7_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(chartInstance->c7_q_i_c_km1, 22U,
...
static void c7_info_helper(c7_ResolvedFunctionInfo c7_info[64])
{
  ...
  c7_info[22].fileTimeLo = 1286840378U;
  ...
  c7_info[27].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c7_info[27].fileTimeLo = 1323192178U;
  c7_info[27].fileTimeHi = 0U;
  c7_info[27].mFileTimeLo = 0U;
  c7_info[27].mFileTimeHi = 0U;
  c7_info[28].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c7_info[28].name = "eml_scalar_eg";
  c7_info[28].dominantType = "double";
  c7_info[28].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c7_info[28].fileTimeLo = 1286840396U;
  c7_info[28].fileTimeHi = 0U;
  c7_info[28].mFileTimeLo = 0U;
  c7_info[28].mFileTimeHi = 0U;
  c7_info[29].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c7_info[29].name = "eml_xgemm";
  c7_info[29].dominantType = "char";
  c7_info[29].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c7_info[29].fileTimeLo = 1299098372U;
  c7_info[29].fileTimeHi = 0U;
  c7_info[29].mFileTimeLo = 0U;
  c7_info[29].mFileTimeHi = 0U;
  c7_info[30].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c7_info[30].name = "eml_blas_inline";
  c7_info[30].dominantType = "";
  c7_info[30].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_blas_inline.m";
  c7_info[30].fileTimeLo = 1299098368U;
  ...
  c7_info[31].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c7_info[31].fileTimeLo = 1289541292U;
  ...
  c7_info[37].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c7_info[37].fileTimeLo = 1323192178U;
  ...
  c7_info[41].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c7_info[41].fileTimeLo = 1289541292U;
  ...
  c7_info[42].fileTimeLo = 1305339600U;
  ...
  c7_info[43].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c7_info[43].fileTimeLo = 1323192178U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4243120241U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2443553021U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2255874926U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(24613771U);
}
...
mxArray *sf_c7_Control_System_Library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("4NWJNu4Lwi14IqXavr9FsE");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,5,1,0,0,0,1,0,2,1);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1350);
        _SFD_CV_INIT_EML_FCN(0,1,"skew_matrix",1352,-1,1512);
        _SFD_CV_INIT_EML_FCN(0,2,"Kinematics",1514,-1,1950);
        _SFD_CV_INIT_EML_FCN(0,3,"quatmultiply",1952,-1,2545);
        _SFD_CV_INIT_EML_FCN(0,4,"quatinv",2547,-1,2645);
        _SFD_CV_INIT_EML_IF(0,1,0,297,339,631,1345);
        _SFD_CV_INIT_EML_FOR(0,1,0,742,753,1073);
...
static void mdlSetWorkWidths_c7_Control_System_Library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1465136862U));
  ssSetChecksum1(S,(1351757088U));
  ssSetChecksum2(S,(421614108U));
  ssSetChecksum3(S,(646304754U));
