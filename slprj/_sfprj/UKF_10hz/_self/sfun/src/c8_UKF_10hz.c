...
static const char * c8_debug_family_names[8] = { "tj2000", "t", "century",
  "theta", "nargin", "nargout", "time", "c_ecef2eci" };

/* Function Declarations */
static void initialize_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance);
static void initialize_params_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct
  *chartInstance);
static void enable_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance);
static void disable_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct
  *chartInstance);
static void set_sim_state_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c8_st);
static void finalize_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance);
static void sf_gateway_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance);
static void initSimStructsc8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c8_c_ecef2eci, const char_T *c8_identifier, real_T c8_y[9]);
static void c8_b_emlrt_marshallIn(SFc8_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[9]);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_UKF_10hzInstanceStruct *chartInstance,
...
static void c8_eml_scalar_eg(SFc8_UKF_10hzInstanceStruct *chartInstance);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_d_emlrt_marshallIn(SFc8_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_e_emlrt_marshallIn(SFc8_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_UKF_10hz, const char_T *c8_identifier);
static uint8_T c8_f_emlrt_marshallIn(SFc8_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_UKF_10hzInstanceStruct *chartInstance);
...
static void initialize_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_UKF_10hz = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c8_c_ecef2eci)[9];
  c8_c_ecef2eci = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c8_st = NULL;
  c8_st = NULL;
  c8_y = NULL;
  sf_mex_assign(&c8_y, sf_mex_createcellmatrix(2, 1), false);
  for (c8_i0 = 0; c8_i0 < 9; c8_i0++) {
    c8_u[c8_i0] = (*c8_c_ecef2eci)[c8_i0];
  }

  c8_b_y = NULL;
  sf_mex_assign(&c8_b_y, sf_mex_create("y", c8_u, 0, 0U, 1U, 0U, 2, 3, 3), false);
  sf_mex_setcell(c8_y, 0, c8_b_y);
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_UKF_10hz;
  ...
  const mxArray *c8_st)
{
  ...
  for (c8_i1 = 0; c8_i1 < 9; c8_i1++) {
    (*c8_c_ecef2eci)[c8_i1] = c8_dv0[c8_i1];
  }

  chartInstance->c8_is_active_c8_UKF_10hz = c8_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 1)), "is_active_c8_UKF_10hz");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_UKF_10hz(chartInstance);
...
static void sf_gateway_c8_UKF_10hz(SFc8_UKF_10hzInstanceStruct *chartInstance)
{
  ...
  int32_T c8_i5;
  real_T *c8_b_time;
  real_T (*c8_b_c_ecef2eci)[9];
  c8_b_c_ecef2eci = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c8_b_time = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 5U, chartInstance->c8_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c8_b_time, 0U);
  chartInstance->c8_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 5U, chartInstance->c8_sfEvent);
  c8_hoistedGlobal = *c8_b_time;
  c8_time = c8_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 8U, 8U, c8_debug_family_names,
    c8_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_tj2000, 0U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_t, 1U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_century, 2U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_theta, 3U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 5U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c8_time, 6U, c8_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_c_ecef2eci, 7U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 2);
  c8_tj2000 = c8_time - 2.451545E+6;
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 3);
  c8_t = c8_tj2000 * 86400.0;
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, 4);
  c8_A = c8_tj2000;
  c8_x = c8_A;
  c8_b_x = c8_x;
  c8_c_x = c8_b_x;
  c8_century = c8_c_x / 36525.0;
  ...
  c8_eml_scalar_eg(chartInstance);
  c8_c = c8_d_a * c8_d_a;
  c8_theta = (4.895 + c8_t * 7.2921E-5) + 0.000388 * c8_c;
  ...
  c8_f_x = -c8_theta;
  c8_g_x = c8_f_x;
  c8_g_x = muDoubleScalarSin(c8_g_x);
  c8_h_x = -c8_theta;
  c8_i_x = c8_h_x;
  c8_i_x = muDoubleScalarSin(c8_i_x);
  c8_j_x = -c8_theta;
  c8_k_x = c8_j_x;
  c8_k_x = muDoubleScalarCos(c8_k_x);
  c8_c_ecef2eci[0] = c8_e_x;
  c8_c_ecef2eci[3] = c8_g_x;
  c8_c_ecef2eci[6] = 0.0;
  c8_c_ecef2eci[1] = -c8_i_x;
  c8_c_ecef2eci[4] = c8_k_x;
  c8_c_ecef2eci[7] = 0.0;
  c8_i2 = 0;
  for (c8_i3 = 0; c8_i3 < 3; c8_i3++) {
    c8_c_ecef2eci[c8_i2 + 2] = c8_dv1[c8_i3];
    c8_i2 += 3;
  }
  ...
  for (c8_i4 = 0; c8_i4 < 9; c8_i4++) {
    (*c8_b_c_ecef2eci)[c8_i4] = c8_c_ecef2eci[c8_i4];
  }
  ...
  for (c8_i5 = 0; c8_i5 < 9; c8_i5++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_c_ecef2eci)[c8_i5], 1U);
  }
}
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_u[9];
  const mxArray *c8_y = NULL;
  SFc8_UKF_10hzInstanceStruct *chartInstance;
  chartInstance = (SFc8_UKF_10hzInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c8_c_ecef2eci, const char_T *c8_identifier, real_T c8_y[9])
{
  ...
  c8_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_c_ecef2eci), &c8_thisId,
                        c8_y);
  sf_mex_destroy(&c8_c_ecef2eci);
}
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  SFc8_UKF_10hzInstanceStruct *chartInstance;
  chartInstance = (SFc8_UKF_10hzInstanceStruct *)chartInstanceVoid;
  c8_c_ecef2eci = sf_mex_dup(c8_mxArrayInData);
...
const mxArray *sf_c8_UKF_10hz_get_eml_resolved_functions_info(void)
{
  const mxArray *c8_nameCaptureInfo = NULL;
  c8_nameCaptureInfo = NULL;
  sf_mex_assign(&c8_nameCaptureInfo, sf_mex_createstruct("structure", 2, 24, 1),
                false);
...
static void c8_info_helper(const mxArray **c8_info)
{
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("mpower"), "name", "name", 7);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 9);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("ismatrix"), "name", "name", 9);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 10);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("power"), "name", "name", 10);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 16);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("floor"), "name", "name", 16);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("cos"), "name", "name", 20);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("sin"), "name", "name", 22);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
  ...
  const mxArray *c8_b_is_active_c8_UKF_10hz, const char_T *c8_identifier)
{
  ...
  c8_y = c8_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_UKF_10hz), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_UKF_10hz);
  return c8_y;
}
...
void sf_c8_UKF_10hz_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1250170171U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(380389274U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(142001810U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1129282513U);
}

mxArray *sf_c8_UKF_10hz_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("7f9SDkw4ejBpvZV0gvCAVC");
...
mxArray *sf_c8_UKF_10hz_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_UKF_10hz_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_UKF_10hz(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"c_ecef2eci\",},{M[8],M[0],T\"is_active_c8_UKF_10hz\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_UKF_10hz_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_UKF_10hzInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"c_ecef2eci");
...

        {
          real_T *c8_time;
          real_T (*c8_c_ecef2eci)[9];
          c8_c_ecef2eci = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S,
            1);
          c8_time = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c8_time);
          _SFD_SET_DATA_VALUE_PTR(1U, *c8_c_ecef2eci);
        }
      }
    } else {
...
{
  return "0jmSpcluQ3X4ttwcZlivwE";
}

static void sf_opaque_initialize_c8_UKF_10hz(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar);
  initialize_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_UKF_10hz(void *chartInstanceVar)
{
  enable_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_UKF_10hz(void *chartInstanceVar)
{
  disable_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_UKF_10hz(void *chartInstanceVar)
{
  sf_gateway_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_UKF_10hz(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_UKF_10hz();/* state var info */
...
extern void sf_internal_set_sim_state_c8_UKF_10hz(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_UKF_10hz();/* state var info */
  ...
  set_sim_state_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_UKF_10hz(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_UKF_10hz(S);
}

static void sf_opaque_set_sim_state_c8_UKF_10hz(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_UKF_10hz(S, st);
}

static void sf_opaque_terminate_c8_UKF_10hz(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_UKF_10hz(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c8_UKF_10hz((SFc8_UKF_10hzInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_UKF_10hz(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1852656382U));
  ssSetChecksum1(S,(4075131932U));
  ssSetChecksum2(S,(503518867U));
  ssSetChecksum3(S,(1946982569U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_UKF_10hz(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_UKF_10hz(SimStruct *S)
{
  SFc8_UKF_10hzInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_UKF_10hzInstanceStruct *)utMalloc(sizeof
    (SFc8_UKF_10hzInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_UKF_10hzInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_UKF_10hz;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_UKF_10hz;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_UKF_10hz;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_UKF_10hz;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_UKF_10hz;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_UKF_10hz;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_UKF_10hz;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_UKF_10hz;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_UKF_10hz;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_UKF_10hz;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_UKF_10hz;
...
void c8_UKF_10hz_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_UKF_10hz(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_UKF_10hz(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_UKF_10hz(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_UKF_10hz_method_dispatcher.\n"
