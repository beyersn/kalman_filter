...
static const char * c6_debug_family_names[5] = { "nargin", "nargout", "vec", "c",
  "vec_prime" };

/* Function Declarations */
static void initialize_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance);
static void initialize_params_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct
  *chartInstance);
static void enable_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance);
static void disable_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct
  *chartInstance);
static void set_sim_state_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c6_st);
static void finalize_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance);
static void sf_gateway_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance);
static void initSimStructsc6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c6_vec_prime, const char_T *c6_identifier, real_T c6_y[3]);
static void c6_b_emlrt_marshallIn(SFc6_UKF_10hzInstanceStruct *chartInstance,
...
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_UKF_10hzInstanceStruct *chartInstance,
...
static void c6_eml_scalar_eg(SFc6_UKF_10hzInstanceStruct *chartInstance);
static void c6_eml_xgemm(SFc6_UKF_10hzInstanceStruct *chartInstance, real_T
  c6_A[9], real_T c6_B[3], real_T c6_C[3], real_T c6_b_C[3]);
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_UKF_10hz, const char_T *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_UKF_10hzInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_eml_xgemm(SFc6_UKF_10hzInstanceStruct *chartInstance, real_T
  c6_A[9], real_T c6_B[3], real_T c6_C[3]);
static void init_dsm_address_info(SFc6_UKF_10hzInstanceStruct *chartInstance);
...
static void initialize_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_UKF_10hz = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c6_vec_prime)[3];
  c6_vec_prime = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_st = NULL;
  c6_st = NULL;
  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_createcellmatrix(2, 1), false);
  for (c6_i0 = 0; c6_i0 < 3; c6_i0++) {
    c6_u[c6_i0] = (*c6_vec_prime)[c6_i0];
  }

  c6_b_y = NULL;
  sf_mex_assign(&c6_b_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 1, 3), false);
  sf_mex_setcell(c6_y, 0, c6_b_y);
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_UKF_10hz;
  ...
  const mxArray *c6_st)
{
  ...
  for (c6_i1 = 0; c6_i1 < 3; c6_i1++) {
    (*c6_vec_prime)[c6_i1] = c6_dv0[c6_i1];
  }

  chartInstance->c6_is_active_c6_UKF_10hz = c6_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)), "is_active_c6_UKF_10hz");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_UKF_10hz(chartInstance);
...
static void sf_gateway_c6_UKF_10hz(SFc6_UKF_10hzInstanceStruct *chartInstance)
{
  ...
  int32_T c6_i14;
  int32_T c6_i15;
  real_T (*c6_b_vec_prime)[3];
  real_T (*c6_b_c)[9];
  real_T (*c6_b_vec)[3];
  c6_b_vec_prime = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_b_c = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  c6_b_vec = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c6_sfEvent);
  for (c6_i2 = 0; c6_i2 < 3; c6_i2++) {
    _SFD_DATA_RANGE_CHECK((*c6_b_vec)[c6_i2], 0U);
  }

  for (c6_i3 = 0; c6_i3 < 9; c6_i3++) {
    _SFD_DATA_RANGE_CHECK((*c6_b_c)[c6_i3], 1U);
  }

  chartInstance->c6_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c6_sfEvent);
  for (c6_i4 = 0; c6_i4 < 3; c6_i4++) {
    c6_vec[c6_i4] = (*c6_b_vec)[c6_i4];
  }

  for (c6_i5 = 0; c6_i5 < 9; c6_i5++) {
    c6_c[c6_i5] = (*c6_b_c)[c6_i5];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 1U, c6_c_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_vec, 2U, c6_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_c, 3U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_vec_prime, 4U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c6_b_eml_xgemm(chartInstance, c6_dv3, c6_dv4, c6_vec_prime);
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c6_i14 = 0; c6_i14 < 3; c6_i14++) {
    (*c6_b_vec_prime)[c6_i14] = c6_vec_prime[c6_i14];
  }
  ...
  for (c6_i15 = 0; c6_i15 < 3; c6_i15++) {
    _SFD_DATA_RANGE_CHECK((*c6_b_vec_prime)[c6_i15], 2U);
  }
}
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  real_T c6_u[3];
  const mxArray *c6_y = NULL;
  SFc6_UKF_10hzInstanceStruct *chartInstance;
  chartInstance = (SFc6_UKF_10hzInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c6_vec_prime, const char_T *c6_identifier, real_T c6_y[3])
{
  ...
  c6_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_vec_prime), &c6_thisId,
                        c6_y);
  sf_mex_destroy(&c6_vec_prime);
}
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  SFc6_UKF_10hzInstanceStruct *chartInstance;
  chartInstance = (SFc6_UKF_10hzInstanceStruct *)chartInstanceVoid;
  c6_vec_prime = sf_mex_dup(c6_mxArrayInData);
  ...
  for (c6_i19 = 0; c6_i19 < 3; c6_i19++) {
    (*(real_T (*)[3])c6_outData)[c6_i19] = c6_y[c6_i19];
  }
  ...
  *c6_inData)
{
  ...
  for (c6_i21 = 0; c6_i21 < 3; c6_i21++) {
    for (c6_i22 = 0; c6_i22 < 3; c6_i22++) {
      c6_b_inData[c6_i22 + c6_i20] = (*(real_T (*)[9])c6_inData)[c6_i22 + c6_i20];
    }
  ...
  for (c6_i24 = 0; c6_i24 < 3; c6_i24++) {
    for (c6_i25 = 0; c6_i25 < 3; c6_i25++) {
      c6_u[c6_i25 + c6_i23] = c6_b_inData[c6_i25 + c6_i23];
    }
...
const mxArray *sf_c6_UKF_10hz_get_eml_resolved_functions_info(void)
{
  ...
  c6_A[9], real_T c6_B[3], real_T c6_C[3], real_T c6_b_C[3])
{
  ...
  for (c6_i26 = 0; c6_i26 < 3; c6_i26++) {
    c6_b_C[c6_i26] = c6_C[c6_i26];
  }

  for (c6_i27 = 0; c6_i27 < 9; c6_i27++) {
    c6_b_A[c6_i27] = c6_A[c6_i27];
  }

  for (c6_i28 = 0; c6_i28 < 3; c6_i28++) {
    c6_b_B[c6_i28] = c6_B[c6_i28];
  }
  ...
  const mxArray *c6_b_is_active_c6_UKF_10hz, const char_T *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_UKF_10hz), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_UKF_10hz);
  return c6_y;
}
  ...
  c6_A[9], real_T c6_B[3], real_T c6_C[3])
{
  ...
  for (c6_i30 = 0; c6_i30 < 3; c6_i30++) {
    ...
    for (c6_i32 = 0; c6_i32 < 3; c6_i32++) {
      c6_C[c6_i30] += c6_A[c6_i31 + c6_i30] * c6_B[c6_i32];
      c6_i31 += 3;
    }
  }
}
...
void sf_c6_UKF_10hz_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3378821516U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1230949487U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2676908572U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(824345895U);
}

mxArray *sf_c6_UKF_10hz_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("xqJm2Ji5Spw9FYD9tXdHQH");
...
mxArray *sf_c6_UKF_10hz_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_UKF_10hz_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_UKF_10hz(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"vec_prime\",},{M[8],M[0],T\"is_active_c6_UKF_10hz\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_UKF_10hz_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_UKF_10hzInstanceStruct *) chartInfo->chartInstance;
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"vec");
          _SFD_SET_DATA_PROPS(1,1,1,0,"c");
          _SFD_SET_DATA_PROPS(2,2,0,1,"vec_prime");
...

        {
          ...
          real_T (*c6_c)[9];
          real_T (*c6_vec_prime)[3];
          c6_vec_prime = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S,
            1);
          c6_c = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
          c6_vec = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c6_vec);
          _SFD_SET_DATA_VALUE_PTR(1U, *c6_c);
          _SFD_SET_DATA_VALUE_PTR(2U, *c6_vec_prime);
        }
      }
    } else {
...
{
  return "RK2sNpoxjzVOSxC01rGccG";
}

static void sf_opaque_initialize_c6_UKF_10hz(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar);
  initialize_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_UKF_10hz(void *chartInstanceVar)
{
  enable_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_UKF_10hz(void *chartInstanceVar)
{
  disable_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_UKF_10hz(void *chartInstanceVar)
{
  sf_gateway_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_UKF_10hz(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_UKF_10hz();/* state var info */
...
extern void sf_internal_set_sim_state_c6_UKF_10hz(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_UKF_10hz();/* state var info */
  ...
  set_sim_state_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_UKF_10hz(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_UKF_10hz(S);
}

static void sf_opaque_set_sim_state_c6_UKF_10hz(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_UKF_10hz(S, st);
}

static void sf_opaque_terminate_c6_UKF_10hz(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_UKF_10hz(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_UKF_10hz((SFc6_UKF_10hzInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_UKF_10hz(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3957556037U));
  ssSetChecksum1(S,(663789239U));
  ssSetChecksum2(S,(241797714U));
  ssSetChecksum3(S,(1156564096U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_UKF_10hz(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_UKF_10hz(SimStruct *S)
{
  SFc6_UKF_10hzInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_UKF_10hzInstanceStruct *)utMalloc(sizeof
    (SFc6_UKF_10hzInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_UKF_10hzInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_UKF_10hz;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_UKF_10hz;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_UKF_10hz;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_UKF_10hz;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_UKF_10hz;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_UKF_10hz;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_UKF_10hz;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_UKF_10hz;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_UKF_10hz;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_UKF_10hz;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_UKF_10hz;
...
void c6_UKF_10hz_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_UKF_10hz(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_UKF_10hz(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_UKF_10hz(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_UKF_10hz_method_dispatcher.\n"
