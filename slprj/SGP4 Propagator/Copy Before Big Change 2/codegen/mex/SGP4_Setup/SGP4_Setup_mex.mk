START_DIR = \\mtucifs2\home\ATTITU~1\SGP4PR~1\mat

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2013a
MAKEFILE = SGP4_Setup_mex.mk

include SGP4_Setup_mex.mki
...
MEX_FILE_NAME_WO_EXT = SGP4_Setup_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\SGP4_S~1"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\SGP4_S~1/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\SGP4_S~1/%.cpp
	$(CC) $(CPPFLAGS) "$<"
